...
Pinterest needs the additional [administrator readiness workflow](/self-hosting/integrations#readiness-records-for-pinterest) before normal use. Telegram and Discord bot mode requirements live on their provider pages. Discord webhooks do not need it.
