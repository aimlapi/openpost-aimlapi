...
func ApplicationContract(provider, connectionMode string) (ProviderAppContract, bool) {
	...
	contracts := map[string]ProviderAppContract{
		...
		providerLemmy + ":" + ConnectionModeAppPassword:    {Provider: providerLemmy, ConnectionMode: ConnectionModeAppPassword, RequiredFields: []string{"instance_url"}, AdapterBacked: true},
		providerPieFed + ":" + ConnectionModeAppPassword:   {Provider: providerPieFed, ConnectionMode: ConnectionModeAppPassword, RequiredFields: []string{"instance_url"}, AdapterBacked: true},
